/**
 * Item15 payload builder utilities.
 */
...
/**
 * Build property ticket message payload (reply/memo).
 * @param {Object} input - Message input.
 * @returns {Object} Insert payload.
 */
const buildPropertyMessagePayload = (input) => {
...
/**
 * Build property ticket status update payload.
 * @param {Object} input - Status input.
 * @returns {Object} Update payload.
 */
const buildPropertyStatusPayload = (input) => {
