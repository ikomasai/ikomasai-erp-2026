      ...
      {!ticketDetail ? (
        ...
        <View style={[styles.panel, { borderColor: theme.border, backgroundColor: theme.surface }]}>
          <View style={styles.rowBetween}>
            <Text style={[styles.panelTitle, { color: theme.text }]}>物品連絡の詳細</Text>
            <TouchableOpacity
              style={[styles.buttonMini, { backgroundColor: theme.primary }]}
...
const styles = StyleSheet.create({
  ...
  photoCard: { borderWidth: 1, borderRadius: 12, padding: 10, gap: 7 },
  photoImage: {
    width: '100%',
    height: 220,
    borderRadius: 10,
